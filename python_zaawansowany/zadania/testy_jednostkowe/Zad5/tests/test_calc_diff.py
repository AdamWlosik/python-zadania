...
from python_zaawansowany.zadania.testy_jednostkowe.Zad5.functionality.calc_diff import calc_diff
...
class TestCalcDiff:
    ...
    def test_calc_diff(self, mocker):
        ...
        mocker.patch('python_zaawansowany.zadania.testy_jednostkowe.Zad5.functionality.calc_diff.datetime',
