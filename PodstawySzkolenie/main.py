...
from PodstawySzkolenie.zadania.b_PodstawySzkolenie3_1StringiRozszerzenie import (
    Szkolenie2,
)
...
from PodstawySzkolenie.zadania.d_PodstawyKrotkiIZbioryRozszerzenie import (
    Zadanie1KZ,
    Zadanie2KZ,
    Zadanie3KZ,
    Zadanie4KZ,
)
from PodstawySzkolenie.zadania.e_PodstawySlownikiRozszerzenie import (
    Zadanie1S,
    Zadanie3S,
    Zadanie4S,
    Zadanie5S,
...
from PodstawySzkolenie.zadania.f_PodstawyListyRozszerzenie import (
    Zadanie1LR,
    Zadanie2LR,
    Zadanie3LR,
    Zadanie4LR,
...
from PodstawySzkolenie.zadania.g_PodstawyPetleRozszerzenie import (
    Zadanie1PPR,
    Zadanie2PPR,
    Zadanie3PPR,
    Zadanie4PPR,
...
from PodstawySzkolenie.zadania.h_PodstawyStrukturyDanychRozszerzenie import (
    Zadanie1PSDR,
    Zadanie2PSDR,
    Zadanie3SPDR,
    Zadanie4PSDR,
...
from PodstawySzkolenie.zadania.i_Podstawy_Szkolenie_7 import (
    Zadanie1PS7,
    Zadanie3PS7,
    Zadanie4PS7,
    Zadanie5PS7,
...
from PodstawySzkolenie.zadania.j_Podstawy_Szkolenie_8 import (
    Zadanie1PS8,
    Zadanie2PS8,
    Zadanie3PS8,
    Zadanie4PS8,
...
from PodstawySzkolenie.zadania.k_Podstawy_Szkolenie_9 import (
    Zadanie1PS9,
    Zadanie2PS9,
    Zadanie3PS9,
    Zadanie4PS9,
...
from PodstawySzkolenie.zadania.l_Podstawy_Szkolenie_10 import (
    Zadanie1PS10,
    Zadanie2PS10,
    Zadanie3PS10,
    Zadanie4PS10,
    ...
    while True:
        ...
        if szkolenie == 1:
            ...
            if zadanie == 1:
                ...
                print(
                    "Operacje są niepoprawne ponieważ dodajemy liczby int w postaci str"
                )
            elif zadanie == 4:
                szkolenie1.zad4()
            elif zadanie == 5:
                szkolenie1.zad5(
                    [5, -1, 0, 0.0, -1.123, "c", "c", "programowanie", False, True]
                )
            elif zadanie == 6:
                szkolenie1.zad6()
            elif zadanie == 7:
                ...
                print(
                    "Możemy działać jedynie na orginalnym napisie lub utworzyć nową zmienna"
                )
            elif zadanie == 10:
                a = 5
                b = 6
            ...
            if zadanie == 1:
                tekst = input(
                    "Wprowadź dowolny tekst zawierający conajmniej 7 znaków: "
                )
                if len(tekst) < 7:
                ...
                napis = input(
                    "Podaj dowolny napis zawierający na początku 5 białych znaków: "
                )
                if napis[:5].isspace():
            ...
            if zadanie == 1:
                try:
                    bok1, bok2, bok3 = map(
                        int,
                        input(
                            "Podaj 3 długości boków trójkąta oddzielone spacją: "
                        ).split(),
                    )
                except ValueError:
                    print("Nie psuj!")
                ...
                try:
                    liczby = map(
                        int, input("Podaj 3 liczby oddzielone spacją: ").split()
                    )
                except ValueError:
                    print("Nie psuj!")
                    continue
                ...
                try:
                    liczby = map(
                        int, input("Podaj diwe liczby oddzielone spacją: ").split()
                    )
                except ValueError:
                    print("Nie psuj!")
                ...
                while True:
                    wybor = input(
                        'Jeśli chcesz wybrać orła wciśnij "o" \n'
                    ...
                    if wybor not in opcje:
                        ...
                        punktacja = szkolenie3.zad6_punktacja(
                            wylosowano, wybor, punkty_gracza, punkty_komputera
                        )
                        punkty_gracza = punktacja[0]
                        punkty_komputera = punktacja[1]
                    print(
                        f"Punkty gracza: {punkty_gracza}, punkty komputera: {punkty_komputera}"
                    )
                    koniec = input(
                        "Czy chcesz zagrać raz jeszcze? t - zagrajmy, n - zakończy rozgrywkę: "
                    ).lower()
                    if koniec == "t":
                        continue
                    elif koniec == "n":
            ...
            if zadanie == 1:
                ...
                try:
                    poczatek, koniec, dzielnik = map(
                        int,
                        input(
                            "Podaj początek i koniec przedziału oraz "
                            "dzielnik rozdzielone spacją: "
                        ).split(),
                    )
                except ValueError:
                    print("Nie psuj!")
                ...
                poziom_paliwa = szkolenie4.zad9_paliwo(
                    minimum_paliwo, maximum_paliwo, war
                )
                ...
                print(
                    f"Statek kosmiczny {szkolenie4.zad9_dolecial(dystans, odleglosc_orbity)} do orbity"
                )
            elif zadanie == 10:
            ...
            if zadanie == 1:
                ...
                print(
                    f"Zostało użytych {zadanie1.suma_unikalnych_elementow(zbior)} różnych kolorów"
                )
                print(
                    f"Dodałem do zbioru kolor {kolor} \n"
                    f"zbiór: {zadanie1.zbior_dodaj(zbior)}"
                )
                print(
                    f"Usunąłem ze zbioru kolor {kolor} \n"
                ...
                print(
                    f"Wyświetlam wszystkie wyrazy ze zdania w jednej lini: \n"
                    f"{nowe_zdanie}"
                )
                zbior = zadanie2.utworz_zbior(nowe_zdanie)
                print(f"Zbior: {zbior}")
                wyswietlone_wyrazy1 = zadanie2.wyswietl_wybrany_wyraz_zbioru(
                    zbior, 1, 4
                )
                print(
                    f"Suma unikatowych wyrazów w zdaniu: {zadanie2.zlicz_unikatowe(zbior)}"
                )
                ...
                wyswietlone_wyrazy2 = zadanie2.wyswietl_wybrany_wyraz_zbioru(
                    zbior2, 1, 4
                )
                print(
                    f"Elementy nie muszą być takie same ponieważ zbiory mają nie uporządkowaną kolejność \n"
                ...
                print(
                    f"Zbiór A składa się z {zadanie4.zlicz_element(zadanie4.zbiorA)} elementów i zawiera:"
                    f" {zadanie4.zbiorA}"
                )
                print(
                    f"Zbiór B składa się z {zadanie4.zlicz_element(zadanie4.zbiorB)} elementów i zawiera:"
                    f" {zadanie4.zbiorB}"
                )
                zbiorC = zadanie4.utworz_zbiorC()
                print(
                    f"Zbiór C składa się z {zadanie4.zlicz_element(zbiorC)} elementów i zawiera: {zbiorC}"
                )
                zbiorD = zadanie4.utworz_zbiorD()
                print(
                    f"Zbiór D składa się z {zadanie4.zlicz_element(zbiorD)} elementów i zawiera: {zbiorD}"
                )
                zbiorE = zadanie4.utworz_zbiorE()
                print(
                    f"Zbiór E składa się z {zadanie4.zlicz_element(zbiorE)} elementów i zawiera: {zbiorE}"
                )
                zbiorF = zadanie4.utworz_zbiorF()
                print(
                    f"Zbiór F składa się z {zadanie4.zlicz_element(zbiorF)} elementów i zawiera: {zbiorF}"
                )
            ...
            if zadanie == 1:
                ...
                tekst = (
                    "W polowie maja, juz przed wschodem slonca, o trzeciej zaczyna spiewac drozd, po nim rudzik,"
            ...
            if zadanie == 1:
                ...
                max_losowanie = 49
                zadanie2 = Zadanie2LR(
                    szkolenie, zadanie, wynik, min_losowanie, max_losowanie
                )
            ...
            if zadanie == 1:
                ...
                try:
                    n = int(
                        input("Podaj ile pierwszych wyrazu ciągu chcesz wyznaczyć: ")
                    )
                except ValueError:
                    print("Nie psuj")
                fibo = [0, 1]
            ...
            if zadanie == 1:
                ...
                przedzial_min = 5
                przedzial_max = 120
                zadanie2 = Zadanie2PSDR(
                    szkolenie, zadanie, ile_elementow, przedzial_min, przedzial_max
                )
            elif zadanie == 3:
            ...
            if zadanie == 2:
                ...
                zadanie5 = Zadanie5PS7(
                    szkolenie, zadanie, lista_parzyste, lista_nieparzyste
                )
            ...
            if zadanie == 1:
                zadanie1 = Zadanie1PS9(
                    szkolenie, zadanie, "Adam", "Włosik", 6273, "Infomratyka"
                )
                zadanie1.rozwiazanie()
            elif zadanie == 2:
