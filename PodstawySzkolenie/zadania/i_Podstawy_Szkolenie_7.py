...
class Zadanie2PS7(Szkolenie):
    ...
    """Parametr funkcji:
        ...
        Definicja: Domyślny argument to taki, który otrzymuje wartość domyślną w przypadku,
        gdy nie zostanie przekazana wartość podczas wywoływania funkcji.
        Przykład:
        ...
        Definicja: Nazwany argument to taki, który jest przekazywany do funkcji w formie klucz=wartość.
        Pozwala to na przekazywanie argumentów bez konieczności pamiętania kolejności parametrów funkcji.
        Przykład:
